...
\secrel{Сборка binutils канадским крестом}
...
\begin{description}
  ...
  кросс-компилятор, т.е. TARGET встраиваемой системы: i386-linux-uclibc,
...
\lstx{mk/sdk/binhost.mk}{}{azlin/mk/sdk/binhost.mk}{mk}
