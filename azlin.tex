...
\secrel{\prog{crox.py}: Генератор конфигураций на Python}

В систему сборки был добавлен экспериментальный модуль генерации конфигураций
сборки, использующий объектные возможности языка Python: все параметры
конфигурации прописаны как классы и объекты с наследованием свойств и прочими
плюшками. Предполагается что использование такого скрипта для генерации
\make файлов даст гибкость в описании вариантов сборки, позволит прописывать
зависимости между опциями, в более поздних версиях возможно будет добавлен
графический интерфейс.

С помощью использования GraphViz скриптом строится графическое
представления дерева зависимостей:

\begin{itemize}[nosep]
  \item зеленый: наследование классов
  \item синий: инстанциация объекта от класса
  \item красный: использование объектов в объектах
\end{itemize}

\noindent\includegraphics[width=0.95\textwidth]{azlin/doc/crox.pdf}

\lstx{crox.py}{}{azlin/crox.py}{Python}
...
% \includegraphics[height=0.45\textheight]{azlin/doc/vocore1.jpg}
% 
% \includegraphics[height=0.45\textheight]{azlin/doc/vocore2.jpg}
