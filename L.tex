\secrel{ALYEH:Linux}\label{L}\secdown
...
\lstx{Makefile}{}{L/Makefile}{mk}\index{L!скрипт!Makefile}
...
% переменную \var{APP}, доступные значения:
% 
% \begin{enumerate}
...
% 
% \lstx{\var{APP} @ \file{hw/head.mk}}{}{tmp/azlin_APP}{mk}
...
% 
% \secrel{\var{HW}: Поддерживаемое железо}\label{azhw}\index{azLinux!железо}
% 
